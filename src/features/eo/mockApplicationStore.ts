...
export const INITIAL_EO_APPLICATIONS: EoApplicationRecord[] = [
  ...
  {
    applicationId: "app_eo_demo_pending",
    identityId: "eo_pending_user",
    businessName: "Lestari Wellness Journey",
    contactPerson: "Maya Safira",
    phone: "081255667788",
    email: "maya@lestariwellness.id",
    province: "Jawa Timur",
    city: "Surabaya",
    experienceDescription:
      "Komunitas perjalanan hening dan respirasi mindfulness di alam terbuka.",
    portfolioLink: "https://instagram.com/lestariwellness",
    yearsOfOperation: 2,
    guideStatus: "CERTIFIED_GUIDE",
    guideCertificateDoc: {
      name: "Sertifikat_Pemandu_BNSP_2026.pdf",
      uploadedAt: "2026-08-25T08:00:00Z",
      status: "ATTACHED",
    },
    insuranceDoc: {
      name: "Polis_Asuransi_Perjalanan.pdf",
      uploadedAt: "2026-08-25T08:00:00Z",
      status: "ATTACHED",
    },
    agreedToSop: true,
